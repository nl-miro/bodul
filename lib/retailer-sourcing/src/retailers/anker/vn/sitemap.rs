...
mod tests {
    ...
    fn classifies_products() {
        let urls = [
            "https://www.anker.com/vn/products/a1259-built-in-cable-power-bank-10000mah",
            "https://www.anker.com/vn/products/a1263",
            "https://www.anker.com/vn/products/a1268",
        ];
    ...
    fn classifies_catalog() {
        let urls = [
            "https://www.anker.com/vn/collections/4-phone-charges",
            "https://www.anker.com/vn/collections/ac-power",
            "https://www.anker.com/vn/collections/adapters",
        ];
    ...
    fn classifies_content() {
        let urls = ["https://www.anker.com/vn/blogs/news"];
    ...
    fn classifies_not_interested() {
        assert_eq!(
            classify_link("https://www.anker.com/vn/pages/warranty", PAGES_INDEX, 0),
            LinkKind::NotInterested,
            "for pages index"
        );
        assert_eq!(
            classify_link("https://www.anker.com/vn/products/a1263", SITEMAP_0, 0),
            LinkKind::NotInterested,
            "for sitemap-0"
        );
    }
    ...
    fn path_matching_is_case_insensitive() {
        assert_eq!(
            classify_link("HTTPS://WWW.ANKER.COM/VN/PRODUCTS/A1263", PRODUCTS_INDEX, 0),
            LinkKind::Product,
            "for uppercased url"
        );
    }
