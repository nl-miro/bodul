...
pub fn from_location(url: &str, source: &str) -> LinkKind {
    ...
    if let Some(y) = matced_by_source {
        if !path.starts_with("https://www.anker.com/my/") {
...
mod tests {
    ...
    fn classifies_products() {
        let urls = [
            "https://www.anker.com/my/products/a1259-built-in-cable-power-bank-10000mah",
            "https://www.anker.com/my/products/a1288",
            "https://www.anker.com/my/products/a1289",
        ];
    ...
    fn classifies_catalog() {
        let urls = [
            "https://www.anker.com/my/collections/1-2-phone-charges",
            "https://www.anker.com/my/collections/3-4-phone-charges",
            "https://www.anker.com/my/collections/4-phone-charges",
        ];
    ...
    fn classifies_content() {
        let urls = ["https://www.anker.com/my/blogs/news"];
    ...
    fn classifies_not_interested() {
        assert_eq!(
            classify_link("https://www.anker.com/my/pages/warranty", PAGES_INDEX, 0),
            LinkKind::NotInterested,
            "for pages index"
        );
        assert_eq!(
            classify_link("https://www.anker.com/my/products/a1288", SITEMAP_0, 0),
            LinkKind::NotInterested,
            "for sitemap-0"
        );
    }
    ...
    fn path_matching_is_case_insensitive() {
        assert_eq!(
            classify_link("HTTPS://WWW.ANKER.COM/MY/PRODUCTS/A1288", PRODUCTS_INDEX, 0),
            LinkKind::Product,
            "for uppercased url"
        );
    }
